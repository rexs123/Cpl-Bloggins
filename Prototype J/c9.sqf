...
_this forceAddUniform "TFC_CU_CombatUniform_otw_cadpat_PJ";
_this addVest "TFC_CV_Tacvest_PJ";
_this addBackpack "TFC_CB_Smallpack_PJ";
...
for "_i" from 1 to 2 do {_this addItemToBackpack "rhsusf_200rnd_556x45_mixed_box";};
_this addHeadgear "TFC_CH_CG634_CADPAT_PJ";
